...
\begin{enumerate}
    ...
    \item Oscar handles the Particle Mesh algorithm implementation (simple, thread based and cuda implementation) % @Oscar, is the cuda implementation still there? Else, remove the bit on it.
\end{enumerate}
